                        ...
                        <div class="col-lg-5">
                            <div class="card border-0 rounded-lg mt-5 sb-sidenav-dark">
                                <div class="card-header text-center ">
                                    <h3 class="font-weight my-4">TESSFP</h3>
                                    <img class="img-thumbnail" src="<?php echo base_url(); ?>Assets/img/tec1.jpg" width="150">
                                </div>
                                <div class="card-body">
            ...
            <footer class="py-4 bg-light mt-auto">
                <div class="container-fluid">
                    <div class="d-flex align-items-center justify-content-between small">
                        <div class="text-muted">Copyright &copy; Ingenieria Informática </div>
                    </div>
                </div>
            </footer>
        </div>
